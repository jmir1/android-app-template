    ...
    publications {
        create<MavenPublication>("release") {
            ...
            pom {
                ...
                url.set("https://github.com/jmir1/android-app-template/")
                ...
                scm {
                    connection.set("scm:git:git://github.com/jmir1/android-app-template.git")
                    developerConnection.set("scm:git:ssh://github.com/jmir1/android-app-template.git")
                    url.set("https://github.com/jmir1/android-app-template/")
                }
                issueManagement {
                    system.set("GitHub Issues")
                    url.set("https://github.com/jmir1/android-app-template/issues")
                }
            }
        }
    }
